...
#include "ui_wk6500Function.h"

class wk6500Function : public QDialog, private Ui::wk6500Function
{
    Q_OBJECT
    
public:
    explicit wk6500Function(bool btnOffVisible=true, bool btnRdcVisible=true, QWidget *parent = 0);
